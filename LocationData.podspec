#
#  Be sure to run `pod spec lint LocationData.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/windsway/LocationData"
  ...
  spec.source       = { :git => "https://github.com/windsway/LocationData.git", :tag => "#{spec.version}" }
